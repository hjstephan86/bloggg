...
Je höher die Relationsdichte einer Datenbank ist, desto höher sind die Performance-Anforderungen (Query Result Time, ...) an das RDBMS. Je klarer die Relationsstruktur einer Datenbank ist, desto effizienter kann das RDBMS Performance-Anforderungen bearbeiten. Dies ist wichtig für den Entwurf von Datenbanken, damit das RDBMS Performance-Anforderungen effizient bearbeiten kann.
