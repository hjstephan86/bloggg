...
class Driver(uvm_driver):
    ...
    async def run_phase(self):
        while True:
            ...
            if seg_value == 0b1000000 or seg_value == 0x40:
                result = 0
            elif seg_value == 0b1111001 or seg_value == 0x79:
                result = 1
            else:
...
class Coverage(uvm_subscriber):
    ...
    def report_phase(self):
        ...
        self.logger.info(f"Coverage: {covered}/{total_combinations} combinations ({coverage_percent:.1f}%)")
